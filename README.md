...
2. Here's how the app works:
   ...
   * When the game starts, the player will choose a character by clicking on the fighter's picture. The player will fight as that character for the rest of the game.
   ...
   //background image set to initial image
   //characters presented as choose your character
   ...
   //enemy selection
     ...
     -update display of background
     -update display of character to include attacks, health, etc

   //fight
     onclick event - attacks
     -evaluate speed (who attacks first)
